...
func (r *InMemRepository) CreatePost(ctx context.Context, title, content, author string, commentsEnabled bool) (*models.Post, error) {
	return r.posts.create(title, content, author, commentsEnabled), nil
}

func (r *InMemRepository) GetPosts(ctx context.Context, limit, offset int) ([]*models.Post, error) {
	return r.posts.list(limit, offset)
}

func (r *InMemRepository) GetPostByID(ctx context.Context, id int64) (*models.Post, error) {
	return r.posts.getByID(id)
}

func (r *InMemRepository) CreateComment(ctx context.Context, postID int64, parentID *int64, author, content string) (*models.Comment, error) {
...
func (r *InMemRepository) GetComments(ctx context.Context, postID int64, parentID *int64, limit, offset int) ([]*models.Comment, error) {
	return r.comments.list(postID, parentID, limit, offset)
}

func (r *InMemRepository) EnsureCommentsEnabled(ctx context.Context, postID int64) error {
