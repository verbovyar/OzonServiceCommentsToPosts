...
func NewPostgresRepository(pool interfaces.PgxPoolIface) *PostgresStore {
	return &PostgresStore{pool: pool}
}

func (s *PostgresStore) CreatePost(ctx context.Context, title, content, author string, commentsEnabled bool) (*models.Post, error) {
	const query = `
...
func (s *PostgresStore) GetPosts(ctx context.Context, limit, offset int) ([]*models.Post, error) {
	const query = `
...
func (s *PostgresStore) GetPostByID(ctx context.Context, id int64) (*models.Post, error) {
	const query = `
		SELECT id, title, content, author, comments_enabled, created_at
		FROM posts
		WHERE id = $1
...
func (s *PostgresStore) CreateComment(ctx context.Context, postID int64, parentID *int64, author, content string) (*models.Comment, error) {
...
func (s *PostgresStore) GetComments(ctx context.Context, postID int64, parentID *int64, limit, offset int) ([]*models.Comment, error) {
	base := `
...
func (s *PostgresStore) EnsureCommentsEnabled(ctx context.Context, postID int64) error {
